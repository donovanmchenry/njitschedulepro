          ...
          <div className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-y-auto">
            {filteredCourses.slice(0, 20).map((course) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400">{course.sections.length} sections</div>
              </button>
            ))}
          </div>
        )}
        ...
        {selectedCourseKeys.length === 0 ? (
          ...
          selectedCourseKeys.map((courseKey) => {
            ...
            return (
              <div
                key={courseKey}
                className="flex items-center justify-between bg-blue-100 dark:bg-blue-900/40 px-3 py-2 rounded-lg border border-blue-200 dark:border-blue-700"
              >
                <div>
